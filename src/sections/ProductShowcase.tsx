  ...
  return (
    <section className="bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] py-24 overflow-x-clip">
      <div className="container">
        ...
        <Image src={pyramid} alt="pyramid" height={262} width={262} className="absolute -right-36 -top-32"/>
        <Image src={tube} alt="tube" height={262} className="absolute bottom-24 -left-36"/>
        </div>
      </div>
    </section>
  );
